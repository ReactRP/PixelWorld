...
RegisterNetEvent('pw:chat:client:ClearChat')
...
AddEventHandler('pw:chat:client:ClearChat', function(name)
  SendNUIMessage({
    type = 'ON_CLEAR'
  })
end)
...
RegisterNetEvent('pw_chat:refreshChat')
AddEventHandler('pw_chat:refreshChat', function()
  Wait(500)
  refreshCommands()
  refreshThemes()
  TriggerServerEvent('pw_chat:refreshChat')
end)
