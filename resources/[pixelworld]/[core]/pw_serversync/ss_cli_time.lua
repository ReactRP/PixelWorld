...
RegisterNetEvent("pw_serversync:updateFromServerTime")
AddEventHandler("pw_serversync:updateFromServerTime", function(serverSecondOfDay,serverDate,isTimeFrozen)
    frozen = isTimeFrozen
