...
AddEventHandler( "onClientMapStart", function()
    ...
    TriggerServerEvent( "pw_serversync:changeWeather",true )
end)

RegisterNetEvent("pw_serversync:changeWeather")
AddEventHandler("pw_serversync:changeWeather", function(newWeather,blackout,startup)
