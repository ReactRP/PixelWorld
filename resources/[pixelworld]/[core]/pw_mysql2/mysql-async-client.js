...
function setNuiActive(boolean = true) {
  if (boolean !== isNuiActive) {
    if (boolean) {
      window.emitNet('pw_mysql2:request-data');
    }
    isNuiActive = boolean;
...
window.onNet('pw_mysql2:update-resource-data', (resourceData) => {
...
window.onNet('pw_mysql2:update-time-data', (timeData) => {
  let timeArray = [];
...
window.onNet('pw_mysql2:update-slow-queries', (slowQueryData) => {
