...
$(function() {
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) { // Escape key
            ...
            $.post('http://pw_clicker/escape', JSON.stringify({}));
        }
    };
});
...
(function($) {
  ...
  function init($param) {
      ...
      if($param !=1 )
        $("#container > p").append("<br><h4>attempts</h4>");
      else
        $("#container > p").append("<br><h4>attempt</h4>");
    }
 ...
 function startgame(tries) {
        ...
        $('#circle').click(function() {
          ...
          if (unghi > angle - 25 && unghi < angle + 25) {
            ...
            if (!digits) {
              setTimeout(function(){ location.reload(); }, 500);
              $.post('http://pw_clicker/process', JSON.stringify({
                state: true
                }));
            }
