...
exports('debugActive', function()
    return dickheaddebug
end)
...
AddEventHandler("hud:enabledebug",function()
    if characterLoaded then
        ...
        if dickheaddebug then
            exports.pw_notify:SendAlert('success', 'Debug Enabled', 2500)
        else
            exports.pw_notify:SendAlert('error', 'Debug Disabled', 2500)
        end
    end
end)
    ...
    while true do 
        ...
        if dickheaddebug then
            ...
            if IsControlJustReleased(0, 38) then
                if inFreeze then
                    inFreeze = false
                    exports.pw_notify:SendAlert('error', 'Freeze Disabled', 2500)        
                else
                    inFreeze = true             
                    exports.pw_notify:SendAlert('success', 'Freeze Disabled', 2500)             
                end
            end
            ...
            if IsControlJustReleased(0, 47) then
                if lowGrav then
                    lowGrav = false
                    exports.pw_notify:SendAlert('error', 'Low Grav Disabled', 2500)             
                else
                    lowGrav = true              
                    exports.pw_notify:SendAlert('success', 'Low Grav Enabled', 2500)                  
                end
            end
