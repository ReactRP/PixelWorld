...
Citizen.CreateThread(function()
    AddTextEntry('RX7TUNABLE', '2002 Mazda RX7 Spirit R') -- Enter Gamename from vehicles.lua and what you want it to display.
    AddTextEntry('na6', '1998 Mazda MX-5 Miata')
